...
#
# - Use compatible widths on selective TT hinted fonts.
...
# Possible options: 
# 
# DEFAULT      - Use above settings.  Equal to INFINALITY if unchanged.
...
# NUDGE        - Infinality with lightly stem snapping and tweaks
# INFINALITY   - Full stem snapping and tweaks without sharpening
