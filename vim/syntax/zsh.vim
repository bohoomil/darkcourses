...
" respectively.
if !exists("b:is_kornshell") && !exists("b:is_zsh")
...
" =====================
 if exists("b:is_zsh")
  syn keyword shStatement bind builtin dirs disown enable help local logout popd pushd setopt unsetopt shopt source
 else
...
if exists("b:is_zsh")
  hi def link zshAdminStatement	shStatement
  hi def link zshSpecialVariables	shShellVariables
  hi def link zshStatement		shStatement
